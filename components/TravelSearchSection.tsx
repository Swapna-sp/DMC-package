...
//             className={`flex items-center px-4 py-2 rounded-full text-sm transition-all ${
//               activeTab === tab.id
//                 ? 'bg-[#B5F5A4] text-black'
//                 : 'bg-[#2A2745] text-white'
//             }`}
//           >
//             {tab.icon}
//             <span className="ml-2">{tab.label}</span>
...
//         <button
//           onClick={handleSubmit}
//           className="w-full bg-[#1C1A2E] text-white py-3 rounded-md text-sm font-semibold"
//         >
//           Search
//         </button>
//       </div>
...
//       {/* Quick Search Tags */}
//       <div className="mt-8 text-center space-x-2 text-sm text-white/80">
//         {quickSearchTags.map((tag) => (
//           <button
//             key={tag}
